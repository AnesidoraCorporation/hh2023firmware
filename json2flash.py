...
parser = argparse.ArgumentParser(description='The Hacker Hotel 2023 EEPROM builder')
parser.add_argument("-f", default='hotel.json', help="JSON file to load")

args = parser.parse_args()
json_file = str(args.f)
eeprom_file = json_file.replace("json","bin")
...
eeprom = open(eeprom_file, 'wb')
eeprom.write(xor_data)
eeprom.close

eeprom = open('gamedata.py', 'wb')
eeprom.write(b'gamedata="""')
eeprom.write(base64.b64encode(xor_data))
eeprom.write(b'"""')
eeprom.close
